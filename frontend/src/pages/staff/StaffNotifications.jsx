...
export default function StaffNotifications() {
  ...
  const markAllRead = async () => {
    try {
      await api.put("/staff/notifications/read");
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Updates on your assigned complaints.</p>
        </div>
        {unreadCount > 0 && (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    {n.complaintId && (
                      <Link to={`/staff/complaints/${n.complaintId}`} className="text-xs text-brand-600 hover:underline">
                        View Complaint →
                      </Link>
                    )}
                  </div>
